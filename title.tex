...
\begin{titlepage}
		...
		\textsc{\Large Department Of Electrical and Computer Engeinring}\\[0.5cm] % Major heading such as course name
		...
		\HRule \\[0.2cm]
		{ \huge \bfseries FAST Diagram \\ Homework Assignment }\\[0.2cm] % Title of your document
		\HRule \\[1.5cm]
		...
		%\includegraphics{MSU-Wordmark-Black.png}
		\\[1cm] 
